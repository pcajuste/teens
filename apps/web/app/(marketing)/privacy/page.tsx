      ...
      <Section className="max-w-2xl">
        <Card className="p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            This page is a placeholder. Teenure&apos;s actual privacy policy — written specifically for a platform
            that handles minors&apos; data, and reviewed by a privacy lawyer for COPPA and state-law compliance
            (including California) — has not been published here yet. No legal text on this page should be relied
            on as Teenure&apos;s privacy policy.
          </p>
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
            ...
            for what data is collected about a minor rep and who can see it.
          </p>
        </Card>
      </Section>
    </main>
