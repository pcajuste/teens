...
const NOT_LIST = [
  ...
  "Not a dating platform — no matching between users, no rep-to-rep contact of any kind.",
  "Not Instagram or TikTok — reps submit private campaign evidence to brands, never public posts.",
  "Not a general content platform — no status updates, no photos, no personal expression outside a bio.",
  "Not an influencer marketplace — reps are verified peer voices with documented track records, not influencers for hire.",
...
const AUDIENCES = [
  ...
  },
  {
    ...
    description:
      "Run authentic peer-influence campaigns with verified reps and get trend intelligence you can't buy anywhere else.",
  },
  {
    href: "/recruiters",
    label: "Recruiters",
    ...
    <>
      <section className="border-b border-border bg-secondary/30">
        <div className="mx-auto max-w-4xl px-4 py-20 text-center sm:py-28">
          <p className="text-xs font-semibold uppercase tracking-wide text-primary">Earn yours early</p>
          <h1 className="mt-4 text-3xl font-semibold tracking-tight sm:text-5xl">
            A verified professional achievement record for teenagers.
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            Every other teen platform captures attention. Teenure captures verified performance. Teens complete
            real brand campaigns, earn real money, and build a documented record that colleges and employers can
      ...
      <Section className="max-w-3xl text-center">
        <p className="text-xs font-semibold uppercase tracking-wide text-primary">The platform rule</p>
        <blockquote className="mt-4 text-xl font-semibold leading-snug tracking-tight sm:text-2xl">
          &ldquo;Teenure is a verified professional achievement record for teenagers. Every feature either adds
          to that record or it does not belong on the platform.&rdquo;
        </blockquote>
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
          If a proposed feature doesn&apos;t directly build, verify, or surface a rep&apos;s achievement record,
          it doesn&apos;t get built — full stop. That single rule is why Teenure looks nothing like a teen social
          app.
        </p>
      </Section>

      <Section className="max-w-5xl">
        <SectionHeading>Built for three people who need proof, not a profile</SectionHeading>
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          {AUDIENCES.map((a) => (
            <Card key={a.href} className="justify-between">
              <CardHeader>
                <p className="text-xs font-semibold uppercase tracking-wide text-primary">{a.label}</p>
      ...
      <Section className="max-w-3xl">
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          Teenure is deliberately narrow. That restraint is a feature, not a limitation.
        </p>
        ...
        <p className="mt-6 text-sm leading-relaxed text-muted-foreground">
          Parents, schools, brands, and colleges all get the same promise: nothing here isn&apos;t serious. Read
          more on our{" "}
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-3xl px-4 py-16 text-center">
          <h2 className="text-2xl font-semibold tracking-tight">See it before you sign up for it</h2>
          <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground">
            Walk through a real rep dashboard — profile, campaigns, and earnings — with no account required.
          </p>
          <div className="mt-6">
