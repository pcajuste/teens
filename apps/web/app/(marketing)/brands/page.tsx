...
const TIERS = [
  {
    ...
    body: "Pay per campaign to activate a curated set of verified talents matched to your target categories and cities.",
  },
  {
    title: "Intelligence Subscription",
    body: "Quarterly trend reports by category, region, and school type — aggregated and anonymized, minimum group size of 10. Never derived from an individual talent's data.",
  },
];
  ...
  return (
    <main>
      <MarketingHero
        ...
        description="Run authentic peer-influence campaigns with verified talents, backed by documented completion — and access trend intelligence you can't buy anywhere else."
      >
      ...
      <Section className="max-w-4xl">
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          Teenure does not sell individual Talent behavioral data, and does not
          support open messaging, discovery, or browsing between your brand and
          talents outside a campaign context. Every submission you receive is
          scoped to the campaign brief, reviewed by you, and the FTC sponsorship
          disclosure is required before a Talent can accept any paid campaign.
        </p>
      </Section>
      ...
      <section className="border-t border-border bg-muted/30">
        <div className="mx-auto max-w-3xl px-4 py-14 text-center sm:px-6">
          <h2 className="text-xl font-semibold tracking-tight sm:text-2xl">
            Ready to reach verified teen voices?
          </h2>
          <div className="mt-6">
            <Link
              href="/brand/signup"
