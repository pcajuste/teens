    ...
    <main>
      ...
      >
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          >
            See a Talent profile
          </Link>
        </div>
      </MarketingHero>

      <Section className="max-w-4xl">
        <SectionHeading>Why talents join</SectionHeading>
      ...
      <Section className="max-w-4xl">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Pick the categories that fit you. Campaigns are matched to your
          categories and city — you never see campaigns outside your interests.
        </p>
      ...
      <Section className="max-w-4xl">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Everything on your profile is self-reported by you and confirmed by
          the brand you worked with — no passive tracking, no data pulled in
          from anywhere else. Your profile is visible to brands and to
          recruiters you opt in to — never to other talents, and never in a
          public feed.
        </p>
      </Section>
      ...
      <Section className="max-w-4xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              A parent or guardian will need to approve your account before it
              activates, and can require approval on each campaign. Read how
              that works on the{" "}
              <Link
                href="/parents"
