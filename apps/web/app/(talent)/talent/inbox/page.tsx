...
// Backend deferred to Prompt 11 (no GET /talents/inbox or POST
// /talents/inbox/:id/read exist yet). Per Prompt 6's own instructions,
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center gap-3 p-6 text-center">
      ...
      <p className="text-sm text-muted-foreground">
        Coming soon. Recruiter messages will appear here as a read-only list --
        there is no reply feature by design.
      </p>
