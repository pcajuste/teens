...
-- milestone involves a count or threshold the rep controls directly
...
-- threshold submit path (app/routers/reps.py submit_milestone) engage.
-- ──────────────────────────────────────────────────────────────────
...
ALTER TABLE public.campaign_rep_milestones
...
ALTER TABLE public.campaign_rep_milestones
  ADD CONSTRAINT campaign_rep_milestones_current_count_non_negative CHECK (current_count >= 0);
