...
--   campaign_talents row and never enters this state machine.

-- talent_profiles.school_type: Build Prompt 2's schema note calls this a
...
-- constrained by CHECK to exactly those four values (see talent_profiles
