...
--
-- Creates fake users across all roles (rep, brand, recruiter, admin),
-- including a parent_records row linked to each under-18 rep, per
...
INSERT INTO auth.users (id, email) VALUES
  ('11111111-1111-1111-1111-111111111101', 'rep.adult@seed.teenure.dev'),
  ('11111111-1111-1111-1111-111111111102', 'rep.minor16@seed.teenure.dev'),
  ('11111111-1111-1111-1111-111111111103', 'rep.minor15@seed.teenure.dev'),
...
VALUES
  ('11111111-1111-1111-1111-111111111101', 'rep.adult@seed.teenure.dev', 'rep', 'active',
    (CURRENT_DATE - INTERVAL '19 years')::date, NULL, NULL),
  ('11111111-1111-1111-1111-111111111102', 'rep.minor16@seed.teenure.dev', 'rep', 'active',
    (CURRENT_DATE - INTERVAL '16 years')::date, 'parent.of16@seed.teenure.dev', now()),
  ('11111111-1111-1111-1111-111111111103', 'rep.minor15@seed.teenure.dev', 'rep', 'active',
...
-- ──────────────────────────────────────────────────────────────────
-- rep_profiles (one adult, one 16yo, one 15yo -- both minors get a
...
INSERT INTO public.rep_profiles (
  ...
  ('aaaaaaaa-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111101',
    ...
    'Adult rep seed fixture.', ARRAY['athletics','gaming'], TRUE),
  ('aaaaaaaa-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111102',
    ...
    '16-year-old rep seed fixture.', ARRAY['fashion'], TRUE),
  ('aaaaaaaa-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111103',
    ...
    '15-year-old rep seed fixture.', ARRAY['music'], FALSE)
ON CONFLICT (id) DO UPDATE SET
...
-- ──────────────────────────────────────────────────────────────────
-- parent_records -- linked to each under-18 rep (16yo and 15yo above).
-- portal_expires_at = rep's 18th birthday, derived from users.date_of_birth.
-- ──────────────────────────────────────────────────────────────────
...
-- ──────────────────────────────────────────────────────────────────
-- One sample campaign + campaign_reps row, useful for RLS/API testing.
-- ──────────────────────────────────────────────────────────────────
...
INSERT INTO public.campaign_reps (id, campaign_id, rep_id, status, parent_approval_status)
VALUES
...
ON CONFLICT (id) DO UPDATE SET status = EXCLUDED.status, invited_at = campaign_reps.invited_at;
